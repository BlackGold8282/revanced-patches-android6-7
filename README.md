...
## A quick announcement (2025-03-19)

The [400] error is finally starting to come!

Let me explain the current situation.

- Google finally started to shutdown the old clients!  
- Old YouTube apps under v19.xx.xx are blocked by [400] error  
- This was being gradually rolled out to some Google accounts.  
- And this is now applied for most accounts.

If your account is targeted:  
- The Home tab only shows "Switch to YouTube.com"  
- Most of other pages return a [400] errors  
- Only the Library tab and video playback is working

<img src="https://github.com/user-attachments/assets/d5b8e1c7-0825-4530-a0ba-60cc7966713a" width="200">

And if you cleared the app data:  
- You will be logged out of the YouTube app.  
- You may still be able to access YouTube normally if the Google Account is logged out.
- But You will never be able to log into your account again.  
  - (The login menu also returns [400] error.) 

Q. Will this be fixed?  
No.  
YouTube 17.34.36 is completely dead.

You can't even use "Spoof app version". Spoofing to 17.40+ breaks the app.  
(It works for a little while, but when the new layout is loaded, the app will crash.)

I'll archive this repository once it is rolled out to all users.

https://t.me/rvx_for_a6_7/87
